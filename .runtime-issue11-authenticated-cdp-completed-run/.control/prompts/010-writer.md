...
Assemble candidate 002 to `drafts/article-002.md` in this isolated workspace by applying the
...
The prose draft has 1671 such characters; the assembled article must have fewer. Take the reduction from the
...
- visuals/article-002/assets/shot-001.png (opportunity opp-001-page-screenshot, alt text "Screenshot of the example.com page on a light grey background, showing a bold heading reading Example Domain, a paragraph reading This domain is for use in documentation examples without needing permission. Avoid use in operations., and a blue underlined Learn more link beneath it.")
...
## Provided context: drafts/article-002-prose.md

<write-uuter-context name="drafts/article-002-prose.md">
...
{
  "schema_version": 1,
  "source_revision": "sha256:dc6bf537178b3ed4cea5d7b40b95be9b393f62e15b5a9d64e942c49bac00b1a2",
  "opportunities": [
    {
