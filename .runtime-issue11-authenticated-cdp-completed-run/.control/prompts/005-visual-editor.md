...
- `plan.json`: the same decisions as `{"schema_version": 1, "source_revision": "sha256:2182d470bbe1c6dc15061f05fbe23e0f842c1e3651de129442cb7053742fcc67", "opportunities": [...]}`.
...
`visuals/article-001/assets/<asset_id>.<ext>`, keeping its extension, which is the exact relative path the assembled article will reference.
