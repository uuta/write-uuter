...
- `plan.json`: the same decisions as `{"schema_version": 1, "source_revision": "sha256:dc6bf537178b3ed4cea5d7b40b95be9b393f62e15b5a9d64e942c49bac00b1a2", "opportunities": [...]}`.
...
`visuals/article-002/assets/<asset_id>.<ext>`, keeping its extension, which is the exact relative path the assembled article will reference.
