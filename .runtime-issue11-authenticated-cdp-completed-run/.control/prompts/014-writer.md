...
Assemble candidate 003 to `drafts/article-003.md` in this isolated workspace by applying the
...
The prose draft has 1638 such characters; the assembled article must have fewer. Take the reduction from the
...
- visuals/article-003/assets/shot-001.png (opportunity opp-002-page-screenshot, alt text "Screenshot of a plain light grey web page showing a bold dark heading reading Example Domain, below it a paragraph reading This domain is for use in documentation examples without needing permission. Avoid use in operations., and below that a blue underlined Learn more link. The rest of the page is empty.")
...
{
  "schema_version": 1,
  "source_revision": "sha256:bf96909840998080db3bdf680db2cb53e452bd80e8c7f426f96406c2bb496f07",
  "opportunities": [
    {
