...
perform evidence, story, or clarity review. Never edit a draft.
...
Write only `reviews/article-001/copy/result.json` and `reviews/article-001/copy/report.md`; never edit a draft.
